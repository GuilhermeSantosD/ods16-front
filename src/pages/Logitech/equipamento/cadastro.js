...
export default function CadastroEquipamentosLogitech() {
    ...
    async function buscarId(id) {
        await api.get('/logitech/' + id).then(response => {
    ...
    function handleSubmit(e) {
        ...
        api.post('/logitech/cadastrar', payload).then(response => {
            ...
            window.location.href = "/logitech/listar";
        }).catch(error => {
            console.log(error);
        })
    }
                ...
                <div className="container-fluid">
                    <div className="card card-primary">
                        <div className="card-header">
                            <h3 className="card-title">Cadastro de um novo equipamento Logitech</h3>
                        </div>
